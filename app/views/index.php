...
<div class="container">
    ...
    <?php
    if (!empty($students) && $is_admin) {
        echo "<a href='matricular.php' class='btn btn-info btn-sm mb-2'>Matricular</a>";
        echo "<a href='matriculados.php' class='btn btn-info btn-sm mb-2 ms-1'>Matriculados</a>";
    }
    if ($is_admin) {
        echo "<a href='users.php' class='btn btn-warning btn-sm mb-2 ms-1'>Usuarios</a>";
    }
    ?>
